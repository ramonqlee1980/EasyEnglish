...
- (id)initWithItems:(NSArray *)items {
	self = [super initWithFrame:CGRectMake(0.0, 411.0, kDeviceWidth, 49.0)];
    //设置背景颜色
//    [self setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:kMainBackgound]]];
	// TODO:
